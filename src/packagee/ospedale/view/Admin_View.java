...
public class Admin_View extends javax.swing.JFrame {
    ...
    private void save_Admin_ViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_Admin_ViewActionPerformed
        ...
        Response response = ControllerRegistry.getInstance().getDoctorController().registerDoctor(id_str, username, password, confirmPassword, firstname, lastname, licence, office, spec);
